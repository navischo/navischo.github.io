...
const initDNELootArr = () => {
    ...
    LootArr.push(new DNELootCard("sonya-xb77", "Sonya XB77", SONYA_LONGLINE, SONYA_IMG, 1, 0, "Бот-Найомничок", SONYA_SHORTLINE, "", true, "npc"));
    ...
    LootArr.push(new DNELootCard("vinyl-i-am-chill-session", "1AM CHILL SESSION", I_AM_CHILL_SESSION_VINYL_LONGLINE, I_AM_CHILL_SESSION_VINYL_IMG, 4, 1600, "Платівка, 160m of Chill Ambient", I_AM_CHILL_SESSION_VINYL_SHORTLINE, "", true, "sound", "https://youtu.be/TlWYgGyNnJo"));
    ...
    LootArr.push(new DNELootCard("demo-fracture", "Fracture", FRACTURE_DEMO_LONGLINE, FRACTURE_DEMO_IMG, 5, "4K", "Демо, 55m of Електро", FRACTURE_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/ah6g-aoXcY8"));
    ...
    LootArr.push(new DNELootCard("demo-nite-fleit", "Nite Fleit", NITE_FLEIT_DEMO_LONGLINE, NITE_FLEIT_DEMO_IMG, 2, 500, "Демо, 54m of Електро", NITE_FLEIT_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/_KlvpRSSU8A"));
    ...
    LootArr.push(new DNELootCard("demo-madness", "Operation Madness", MADNESS_DEMO_LONGLINE, MADNESS_DEMO_IMG, 2, 500, "Демо, 55m of Електро", MADNESS_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/GuQ60ZlYDlo"));
    ...
    LootArr.push(new DNELootCard("demo-sim0ne", "Sim0ne", SIMONA_DEMO_LONGLINE, SIMONA_DEMO_IMG, 3, "1K", "Демо, 54m of Електро", SIMONA_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/JQhB2GdEDRE"));
    ...
    LootArr.push(new DNELootCard("demo-oneman", "Oneman", ONEMAN_DEMO_LONGLINE, ONEMAN_DEMO_IMG, 3, "1K", "Демо, 56m of Електро", ONEMAN_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/4uQWqqTsJ2U"));
    ...
    LootArr.push(new DNELootCard("demo-dj-perception", "DJ Perception", DJ_PERCEPTION_DEMO_LONGLINE, DJ_PERCEPTION_DEMO_IMG, 3, "1K", "Демо, 56m of Електро", DJ_PERCEPTION_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/8HoAazS_12Y"));
    ...
    LootArr.push(new DNELootCard("demo-jordss", "Jordss", LORDSS_DEMO_LONGLINE, LORDSS_DEMO_IMG, 3, "1K", "Демо, 54m of Електро", LORDSS_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/peHfDBoEpAA"));
    ...
    LootArr.push(new DNELootCard("demo-neffa-t", "Neffa T & Flowdan", NEFFA_T_DEMO_LONGLINE, NEFFA_T_DEMO_IMG, 3, "1K", "Демо, 55m of Електро", NEFFA_T_DEMO_SHORTLINE, "", true, "sound", "https://www.youtube.com/live/_Cg0FM42lKo"));
    ...
    LootArr.push(new DNELootCard("demo-ambient-techno-003", "AMBIENT TECHNO MIX 003", AMBIENT_TECHNO_003_LONGLINE, AMBIENT_TECHNO_003_IMG, 2, 0, "Демо, 96m of Ambient Techno", AMBIENT_TECHNO_003_SHORTLINE, "", true, "sound", "https://youtu.be/_TlmWBlYC8Q"));
    ...
    LootArr.push(new DNELootCard("album-sweet-temptation", "Sing Me a Lullaby, My Sweet Temptation", SWEET_TEMPTATION_ALBUM_LONGLINE, SWEET_TEMPTATION_ALBUM_IMG, 3, 500, "Альбом, 36m of Hardwave Hip-Hop", SWEET_TEMPTATION_ALBUM_SHORTLINE, "", true, "sound", "https://youtu.be/vkzJT3Y5n1Y"));
    ...
    LootArr.push(new DNELootCard("album-i-no-longer-fear", "I NO LONGER FEAR THE RAZOR GUARDING MY HEEL I,II,III,IV", ALBUM_I_MO_LONGER_FEAR_LONGLINE, ALBUM_I_MO_LONGER_FEAR_IMG, 2, 0, "Альбом, 30m of Cloud Trap Hip-Hop", ALBUM_I_MO_LONGER_FEAR_SHORTLINE, "", true, "sound", "https://youtu.be/n-E1gnMvzng"));
    ...
    LootArr.push(new DNELootCard("album-dangerous-days", "DANGEROUS DAYS", DANGEROUS_DAYS_ALBUM_LONGLINE, DANGEROUS_DAYS_ALBUM_IMG, 2, "1.2K", "Демо, 69m of Coldwave Synth Retrowave", DANGEROUS_DAYS_ALBUM_SHORTLINE, "", true, "sound", "https://youtu.be/1Vsf3zYppP4"));
    ...
    LootArr.push(new DNELootCard("album-enigma", "ENIGMA", ENIGMA_ALBUM_LONGLINE, ENIGMA_ALBUM_IMG, 9, "NYP", "Альбом, 352m of New-Age Downtempo Experimental Ambient Chillout", ENIGMA_ALBUM_SHORTLINE, "", true, "sound", "https://youtu.be/7Qv6CsSEaPE"));
