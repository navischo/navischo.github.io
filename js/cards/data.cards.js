...
const initBUGArr = () => {
    ...
    const SCROLL_OF_DEBUFFING_LONGLINE = `Грай у будь-який Рейв, щоб скинути всіх Монстрів та підсилювачі, окрім зіграних тобою та твоїм Рятівником, якщо він був.`;
