...
const initDNELootArr = () => {
    ...
    LootArr.push(new DNELootCard("class-writer", "Райтер", "Кинь d6 і зіграй карту Звуку наче її бонус дорівнює числу що випало. Повторюй до трьох разів в свій хід. Ти перемагаєш за рівності сил.", "img/avatars/writer.jpg", 0, 0, "Клас", "", "", true, true, "class", false));
