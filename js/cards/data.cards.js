...
const initMonsterArr = () => {
    ...
    MonstersArr.push(new DNEMonsterCard("cat-girl", "Кицьо-дівчина", 17, "img/monsters/monster-cat-girl.png", "+5 за кожного Найомничка", 1, 3, "Вона забрала в тебе друга та самоповагу! Скинь Найомничка та усі риси характеру"));
    ...
    MonstersArr.push(new DNEMonsterCard("lawyers", "Адвокат", 15, "img/monsters/monster-lawyers.png", "", 1, 2, "Кожен суперник отримує душу, а ти втрачаєш їх відповідну кількість і ще одну, адвокату теж треба за щось жити."))
    MonstersArr.push(new DNEMonsterCard("telemarketer", "Телефонний скамер", 10, "img/monsters/monster-telemarketer.png", "", 1, 1, "Кожен суперник, починаючи з лівого, тягне по карті з твоєї руки. Скинь карти що залишаться."));
    ...
    MonstersArr.push(new DNEMonsterCard("the-hand-of-fate", "Рука долі", 30, "img/monsters/monster-the-hand-of-fate.png", "Якщо досягнеш успіху з Рукою долі, вона стане твоїм Найомничком та не покине тебе<br>за жодних умов", 2, 4, "Гравці ліворуч та праворуч забирають в тебе по Найомничку. Ти сумуєш та втрачаєш дві душі за кожного."));
    MonstersArr.push(new DNEMonsterCard("minor-god", "Дрібний бог", 10, "img/monsters/monster-minor-god.png", "На щось він все-таки здатний. Бонус найсильнішої карти в твоєму лайнапі дорівнює нулю", 1, 1, "Віддай найсильнішу карту зі свого лайнапу гравцю з найменьшою кількістю душ."));
    MonstersArr.push(new DNEMonsterCard("oxymoron", "Абихто", 27, "img/monsters/monster-oxymoron.png", "Баги на нього не діють, просто досі не розуміє як ті працюють", 2, 4, "Він не відчепиться. До кінця наступного ходу дія руху не доступна, а влаштуєш рейв знову і він одразу там буде"));
    ...
    MonstersArr.push(new DNEMonsterCard("blobgoblin", "Жлобгоблін", 10, "img/monsters/monster-blobgoblin.png", "", 1, 1, "Присідає відпочити на твою руку. Тим часом твої сусіди ліворуч та праворуч тягнуть в тебе з руки наосліп по дві карти та залишають собі"));
    ...
    MonstersArr.push(new DNEMonsterCard("chocolate-bunny", "Шоколадний заєць", 8, "img/monsters/monster-chocolate-bunny.png", "+3 для самотніх жінок", 1, 2, "Цукрова кома. До кінця свого наступного ходу не можеш звертатись до Найомничків"));
    ...
    MonstersArr.push(new DNEMonsterCard("obsture-angel", "Тупий янгол", 25, "img/monsters/monster-obsture-angel.png", "", 1, 4, "Не такий вже він і тупий. Скинь руку та дві душі"));
    ...
    MonstersArr.push(new DNEMonsterCard("wight-brothers", "Бліді брати", 29, "img/monsters/monster-wight-brothers.png", "Ігнорують рейви гравців з 6-ма душами чи менше, занадто дрібно", 2, 4, "Втрать усі душі"));
    MonstersArr.push(new DNEMonsterCard("ghoulfiends", "Мадемонуазелі", 20, "img/monsters/monster-ghoulfiends.png", "", 1, 2, "Втрать стільки душ, щоб залилось як у гравця з найменьшою кількістю душ у грі"));
    MonstersArr.push(new DNEMonsterCard("mr-bones", "Містер Бонес", 6, "img/monsters/monster-mr-bones.png", "", 1, 1, "Втрать дві душі. Успішна змивка?<br>Добре, втрать одну душу"));
    MonstersArr.push(new DNEMonsterCard("druid", "Друїд", 28, "img/monsters/monster-druid.png", "Друїдський фреш впливає на всіх дуже не передбачувано, до кінця наступного ходу зіграний<br>будь-ким баг замінюється випадковим(визначайте кидком d6)", 1, 4, "Скинь всі свої баги та рису характеру на твій вибір"));
        MonstersArr.push(new DNEMonsterCard("smog", "Смог", 34, "img/monsters/monster-smog.png", "Архетип Ріка зустрівши Смауга бере дві карти звуку в руку, навіть якщо вже має п'ять", 2, 5, "Скинь стільки душ, скільки карт було в твоєму лайнапі. Зустрінь Найомничка"));
    MonstersArr.push(new DNEMonsterCard("right-angel", "Прямий янгол", 21, "img/monsters/monster-right-angel.png", "Своєю прямотою ставить тебе в глухий кут. +6 для несформованих архетипів", 1, 3, "Скинь рису характеру. Якщо не маєш жодної, візьми дві карти звуку"));
    MonstersArr.push(new DNEMonsterCard("a-cute-angel", "Косий янгол", 10, "img/monsters/monster-a-cute-angel.png", "Його найгірша риса - ніколи не знаєш куди він мітить.<br>+6 для сформованих архетипів,<br>-9 якщо маєш Найомничків", 1, 2, "Втрать три душі, якщо маєш Найомничків. Ще дві, якщо маєш несформований архетип. Ще одну за кожну карту звуку у руці"));
    ...
    MonstersArr.push(new DNEMonsterCard("pinball-lizard", "Пінбольний ящер", 6, "img/monsters/monster-pinball-lizard.png", "Він дійсно круто грає в пінбол.", 1, 1, "Дзинь! Втрать дві душі і карту з найбільшим бонусом."));
    MonstersArr.push(new DNEMonsterCard("net-troll", "Інтернет троль", 11, "img/monsters/monster-net-troll.png", "Нічіго не вміє, тому і біситься.", 1, 3, "Йому чхати на баланс. Дозволь гравцям з найбільшою кількістю душ взяти в тебе по карті на їх вибір"));
    ...
    MonstersArr.push(new DNEMonsterCard("snerks", "Шмурфи", 20, "img/monsters/monster-snerks.png", "Істоти із пекла!<br>+10 в присутності Бульрога, мають тримати імідж", 1, 3, "Скинь дві душі і ще по одній за кожного монстра на рейві, вони точно їм передадуть"));
    MonstersArr.push(new DNEMonsterCard("bullrog", "Бульрог", 28, "img/monsters/monster-bullrog.png", "Не приходить на рейви гравців менше ніж з 6-ма душами", 2, 5, "Твої Найомнички рятуються бігством, інші відмовляються з ним працювати. Приходитиме на кожен твій рейв, доки не досягнеш із ним успіху.. або використаєш бажальне кільце"));
    ...
    MonstersArr.push(new DNEMonsterCard("under-the-bed", "Монстр з під ліжка", 5, "img/monsters/monster-under-the-bed.png", "-4 якщо маєш Найомничків", 1, 1, "Що це за звуки з-під ліжка? Де мої Найомнички? Ти їх втрачаєш, як і всі свої душі"));
    MonstersArr.push(new DNEMonsterCard("meanderthal", "Поневірянець", 15, "img/monsters/monster-meanderthal.png", "Поневірянця можна запросити на будь-який Рейв, не скидуючи карту.", 1, 3, "Вони на це не заслуговують! Віддай половину своїх душ гравцю в якого їх найменше. Їх двоє? Хай забирає другу половину, ти ще заробиш, можливо."));
    MonstersArr.push(new DNEMonsterCard("floating-nose", "Блукаючий ніс", 12, "img/monsters/monster-floating-nose.png", "Шкода свого носа? Скинь дві карти звуку і він піде.", 1, 3, "Він ще той нюхач. Змитись не вийде. Втрать 3 душі"));
    MonstersArr.push(new DNEMonsterCard("the-brothers-grimm", "Брати Грімм", 9, "img/monsters/monster-the-brothers-grimm.png", "Кожен суперник, може скинути карту, щоб підвищити їх рівень на 9.", 1, 1, "Втрать дві душі та ще под одній за кожну раніше скинуту суперниками карту"));
    MonstersArr.push(new DNEMonsterCard("roc-star", "Вьюрок-звезда", 10, "img/monsters/monster-roc-star.png", "Усі карти звуку у жанрі Rock отримують 100% бонус", 1, 2, "Ти неуважно читав його райдер! Cкинь всю руку та душу"));
    ...
    MonstersArr.push(new DNEMonsterCard("unspeakably-awful-indescribable-horror", "Невимовно жахливий незбагненний жах", 28, "img/monsters/monster-unspeakably-awful-indescribable-horror.png", "+7 для несформованих архетипів", 1, 4, "Невимовно жахливим чином висмоктують 7 душ у всіх крім архетипу Джері. Джері втрачає пам'ять - скинь риси характеру Джері"));
    MonstersArr.push(new DNEMonsterCard("stoned-golem", "Обдовбаний голем", 31, "img/monsters/monster-stoned-golem.png", "Завжди можеш просто піти і забити на його звук", 1, 4, "Його пробило на хавку, скинь руку та чотири душі. Це ще довго буде в тебе перед очима"));
    ...
    MonstersArr.push(new DNEMonsterCard("tongue-demon", "Язичницький демон", 22, "img/monsters/monster-tongue-demon.png", "Пекельне створіння. +4 для несформованих архетипів. Скинь карту звуку при зустрічі", 1, 3, "Втрать чотири душі. За бажанням кинь d6, випаде 6 - нічого не втрачаєш, інше - втрачай шість душ"));
    MonstersArr.push(new DNEMonsterCard("lounge-lizards", "Тусящери", 18, "img/monsters/monster-lounge-lizards.png", "+8 для несформованих архетипів", 1, 3, "Їм завжди треба більше. Кинь d6, викинуте число душ роздай іншим гравцям по колу, якщо випаде 6 - отримай душу"));
    MonstersArr.push(new DNEMonsterCard("gms-ex-girlfriend", "Колишня подруга майстра", 9, "img/monsters/monster-gms-ex-girlfriend.png", "Тепер вона найстрашніший монстр у його грі...<br>+4 для самотніх чоловіків", 1, 2, "Жінка втрачає одну душу. Чоловік скидує всю руку, Найомничка та дві душі"));
