...
const initMonsterArr = () => {
    ...
    MonstersArr.push(new DNEMonsterCard("frog-prince", "Царевич-жаба", 6, "img/monsters/monster-frog-prince.png", "Манери в нього так собі,<br> але яка ж все таки економія на мухоловках!<br>Зустрівши Язичницького демона обидва зникають, залишивши тобі свої карти звуку.", 1, 2, "Скинь карту з руки"));
    ...
    MonstersArr.push(new DNEMonsterCard("right-angel", "Прямий янгол", 9, "img/monsters/monster-right-angel.png", "Своєю прямотою заганяє тебе в кут. +3 для Татуєрів", 1, 3, "Скинь карту, що дає тобі особливу здібність, на твій вибір. Якщо такої карти в тебе нема, візьми одну карту на руку"));
...
const initBUGArr = () => {
    ...
    const HOARD_LONGLINE = `Відразу візьми три карти Звука так само, як витягнув цю карту, - у відкриту або в закриту.`;
    BUGArr.push(new DNEBUGCard("bug-hoard", "Ура, клад!", "/img/bug/bug-hoard.png", HOARD_LONGLINE, "", 0, 0, true));
    const GARAGE_SALE_LONGLINE = `Можеш зіграти цю карту відразу як тільки отримав її чи пізніше у свій хід. Скинь карту Звука на свій вибір. Потім візьми зі скиду дві будь-які карти, бонус яких не більший за скинуту.`;
    ...
    const COUPON_LONGLINE = `У будь-який момент, окрім Рейва, можеш обміняти цей купон, щоб взяти зі скидання карти Звука сумарним бонусом не більше 10.`;
