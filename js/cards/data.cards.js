...
const initMonsterArr = () => {
    ...
    MonstersArr.push(new DNEMonsterCard("snerks", "Шмурфи", 20, "img/monsters/monster-snerks.png", "Істоти із пекла!<br>+10 в присутності Бульрога, мають тримати імідж", 1, 4, "Скинь дві душі і ще по одній за кожного монстра на рейві, вони точно їм передадуть"));
