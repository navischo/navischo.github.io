...
Тож почнемо.\r
Мета гри: найбільший банкрол після 10 душі. Для зручності твої душі та банкрол знаходяться поруч, у верхньому правому кутку твого HUD.\r
...
Збережи в зручному для тебе місці ці <a href="libs/DNE_RULES_0.7.pdf" download style="text-decoration: underline">правила гри у PDF</a>. Відчувай себе вільно вивчати їх під час гри та неодмінно звертайся коли знадобиться освіжити пам'ять.`,
...
const INTERACTIVE_DIALOGS = [
    ...
    {
        starter: "Що ти таке?",
        next: "Маю краще питання для тебе. Навіщо я?",
        nextOptions: [
            "Дякую за пояснення!",
