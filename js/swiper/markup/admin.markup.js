            ...
            <div class="app-a">
                ...
                <div class="nav-section">
                    ...
                    <span class="channel-link conversation-link--unread">
                      <span class="channel-link__icon">#</span><span class="channel-link__element">Afterlife</span><span class="channel-link__element"><span class="badge">3</span></span>
                            ...
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                                    <span class="channel-link"><span class="channel-link__icon">#</span><span class="channel-link__element">Otel</span></span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                                    <span class="channel-link"><span class="channel-link__icon">#</span><span class="channel-link__element">Purple Moon</span></span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link nav__link--active" href="#">
                                    <span class="channel-link"><span class="channel-link__icon">#</span><span class="channel-link__element">Green House</span></span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                    <span class="channel-link conversation-link--unread">
                      <span class="channel-link__icon">#</span><span class="channel-link__element">Fight Club</span><span class="channel-link__element"><span class="badge">2</span></span>
                    </span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="nav-section">
                    ...
                    <span class="conversation-link conversation-link--online conversation-link--unread">
                      <span class="conversation-link__icon"></span><span class="conversation-link__element">navischo</span><span class="conversation-link__element"><span class="badge">5</span></span>
                    </span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                    <span class="conversation-link conversation-link--online conversation-link--unread">
                      <span class="conversation-link__icon"></span><span class="conversation-link__element">moon</span><span class="conversation-link__element"><span class="badge">1</span></span>
                    </span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                                    <span class="conversation-link"><span class="conversation-link__icon"></span><span class="conversation-link__element">echomateria</span></span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                                    <span class="conversation-link"><span class="conversation-link__icon"></span><span class="conversation-link__element">olivye</span></span>
                                </a>
                            </li>
                            <li class="nav__item">
                                <a class="nav__link" href="#">
                                    <span class="conversation-link"><span class="conversation-link__icon"></span><span class="conversation-link__element">microdoser</span></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="channel-feed__footer">
                        <form class="channel-message-form" action="#">
                            ...
                            <div class="form-footer">
                                <button class="button button--primary button--size-xl" type="submit"><span class="button__content">Send</span></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<div class="app-skeleton profile">
    <div class="app-container">
        ...
        <div class="app-main">
            <div class="segment-topbar">
                <div class="segment-topbar__header">
                    <span class="segment-topbar__overline segment-topbar__overline">NetWire_Seed: d869db7fe62fb07c25a0403ecaea55031744b5fb</span>
                    <h4 class="text-heading4 segment-topbar__title">
                        <span class="channel-link"><span class="channel-link__icon">#</span><span class="js-channel-name channel-link__element">Profile</span></span>
                    </h4>
                </div>
                <div class="segment-topbar__aside">
                    <div class="button-toolbar">
        ...
        <div class="app-b">
            <h3 class="card-menu__title" style="margin-bottom: 69px ">CENTRAL DATABASE</h3>
...
export { adminMarkup, profileMarkup };
