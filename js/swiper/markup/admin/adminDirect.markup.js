    ...
    `
        <div class="app-skeleton">
            <div class="app-container">
                            ...
                            <ul class="js-locations nav">
                                <li class="nav__item">
                                    ...
                                    <span class="channel-link conversation-link--unread">
                                      <span class="channel-link__icon">#</span><span
                                        class="channel-link__element">Afterlife</span><span
                                        class="channel-link__element"><span class="badge">3</span></span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                        <span class="channel-link"><span
                                            class="channel-link__icon">#</span><span
                                            class="channel-link__element">Otel</span></span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                        <span class="channel-link"><span
                                            class="channel-link__icon">#</span><span
                                            class="channel-link__element">Purple Moon</span></span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link nav__link--active" href="#">
                                        <span class="channel-link"><span
                                            class="channel-link__icon">#</span><span
                                            class="channel-link__element">Green House</span></span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                    <span class="channel-link conversation-link--unread">
                                      <span class="channel-link__icon">#</span><span
                                        class="channel-link__element">Fight Club</span><span
                                        class="channel-link__element"><span class="badge">2</span></span>
                                    </span>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="nav-section__body">
                            <ul class="js-direct-contacts nav">
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                    <span
                                        class="conversation-link conversation-link--online conversation-link--unread">
                                      <span class="conversation-link__icon"></span><span
                                        class="conversation-link__element">navischo</span><span
                                        class="conversation-link__element"><span class="badge">5</span></span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    ...
                                    <span
                                        class="conversation-link conversation-link--online conversation-link--unread">
                                      <span class="conversation-link__icon"></span><span
                                        class="conversation-link__element">moon</span><span
                                        class="conversation-link__element"><span class="badge">1</span></span>
                                    </span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                        <span class="conversation-link"><span
                                            class="conversation-link__icon"></span><span
                                            class="conversation-link__element">echomateria</span></span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                        <span class="conversation-link"><span
                                            class="conversation-link__icon"></span><span
                                            class="conversation-link__element">olivye</span></span>
                                    </a>
                                </li>
                                <li class="nav__item">
                                    <a class="nav__link" href="#">
                                        <span class="conversation-link"><span
                                            class="conversation-link__icon"></span><span
                                            class="conversation-link__element">microdoser</span></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="segment-topbar">
                            <div class="segment-topbar__header">
                                ...
                                <h4 class="text-heading4 segment-topbar__title">
                                    <span class="channel-link"><span class="channel-link__icon">#</span><span
                                        class="js-channel-name channel-link__element">Direct</span></span>
                                </h4>
                            </div>
                            <div class="segment-topbar__aside">
                                <div class="button-toolbar">
                                    ...
                                    <a class="js-open-profile button button--default">
                                        <svg class="button__icon" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 24 24">
                                            <path
                                                d="M6 16h-6v-3h6v3zm-2-5v-10h-2v10h2zm-2 7v5h2v-5h-2zm13-7h-6v-3h6v3zm-2-5v-5h-2v5h2zm-2 7v10h2v-10h-2zm13 3h-6v-3h6v3zm-2-5v-10h-2v10h2zm-2 7v5h2v-5h-2z"></path>
                                        </svg>
                                    </a>
                                    <a class="button button--default">
                                        <svg class="button__icon" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 24 24">
                                            <path
                                                d="M12 18c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zm0-9c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3zm0-9c1.657 0 3 1.343 3 3s-1.343 3-3 3-3-1.343-3-3 1.343-3 3-3z"></path>
                                        </svg>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="channel-feed__footer">
                            <form class="channel-message-form" action="#">
                                <div class="form-group">
                                    ...
                                    <div class="form-control"><textarea id="message" class="form-control"
                                                                            name="message"></textarea></div>
                                </div>
                                <div class="form-footer">
                                    <button class="button button--primary button--size-xl" type="submit"><span
                ...
                <div class="custom-scrollbar --y app-b">
