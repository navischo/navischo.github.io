...
const initDNEDoorArr = () => {
    ...
    // Замовлення, 8lvl
    DoorArr.push(new DNEDoorCard("prj-influence", "Influence Operations", "Замовлення на розробку дебютного діджитал-альбому для артиста лейблу BODY Music, що складатиме компіляція його треків та оригінальний артворк альбому. <br>Чим більше складових проекту розроблено без допомоги лейблу, тим більше заробіток від продажу. Картка може бути використана повторно, кожного разу потребуючи новий бюджет та даючи новий прибуток.", "https://lh5.googleusercontent.com/BpTDR292VB5bP7HD52JYW0YqfpvJnmtiEN02SzIoWp-c5ubGpm0uApobLtL-IfsAbBE=w2400", 8, "2K", "BODY Music", "DJ, Filmmaker*", "BODY Music має затвердити роботу інакше витрачені час та енергія не будуть сплачені грошима", "4K/7K", "Платіж"));
    // Various
    // Замовлення, 19lvl
